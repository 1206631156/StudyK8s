...
public class ActivitiDefineController   {
     ...
     * @param assignment 发起人
     * @return ResultDTO
     */
    @RequestMapping("/startProcessInstanceById")
    public ResultDTO startProcessInstanceById(String processDefinitionId,String assignment) {
        String processInstanceId = "";
        try {
            processDefinitionId = activitiDefineService.startProcessInstanceById(processDefinitionId,assignment);
        } catch (Exception e) {
            return ResultUtils.getFail(e.getMessage());
        }
        return ResultUtils.getSuccess(processDefinitionId);
    }
    ...
    public ResultDTO delete(@RequestParam String[] deploymentId) {
