...
public class ActivitiModelServiceImpl implements ActivitiModelService {
    ...
    @Override
    public ResultDTO queryPage(Map<String, Object> params) {
        Map<String,Object> result = new HashMap<>();
        int page = Integer.parseInt(params.get("startPage") + "");
        int pageSize = Integer.parseInt(params.get("pageSize") + "");

        ModelQuery modelQuery = repositoryService.createModelQuery().latestVersion().orderByLastUpdateTime().desc();
        String modelName =params.get("modelName")==null?"": params.get("modelName").toString();
        if(!"".equals(modelName)){
        ...
        return ResultUtils.getResultDTO(1,"查询成功",result);
    }
